...
// }
//
// impl RawVector<Vec<[(usize,usize,usize,f64,usize);1024]>> {
//
...
//     }
//
//     pub fn raw_vector(in_vec:&Vec<f64>) -> RawVector<Vec<[(usize,usize,usize,f64,usize);1024]>> {
//
//
//
...
//     }
//
//     pub fn reset_by_reference(&mut self, backup: &RawVector<Vec) {
//
...
//     pub fn derive(&self, indecies:&[usize]) -> RawVector<Vec<[(usize,usize,usize,f64,usize);1024]>> {
//
...
// }
//
// impl<T> Index<usize> for RawVector<T> {
