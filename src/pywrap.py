...
def main():
    ...
    trees = fit_file(prefix+"/testing/imputed.txt",trees="200",leaves="100",in_features="400",out_features="1000",feature_subsample="1000",sample_subsample="800",processors="100",output_location=prefix+"/impute_test/run" ,reporting=report_file)
    predict_file(prefix+"/testing/imputed.txt",trees,output_location=prefix+"/impute_test/run")
#
